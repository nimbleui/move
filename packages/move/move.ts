...
export function move(el: MoveElType, options?: MoveOptionsType) {
  ...
  function mousedown(e: MoveMouseTouchEvent) {
  ...
  function mousemove(e: MoveMouseTouchEvent) {
    ...
    _options.move?.({ ...data, e, value: infoData.callbackReturnValue }, setValue('move'))
  }
  ...
  function mouseup(e: MoveMouseTouchEvent) {
    ...
    _options?.up?.({ ...data, e, value: infoData.callbackReturnValue }, setValue('up'));
